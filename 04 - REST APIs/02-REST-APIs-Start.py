...
def loginTableauPage():
    return render_template('listOfWorkbooks-Start.html', tableau_ticket = tableau_ticket_return, username = username_global, tableau_server_version = tableau_server_version, all_workbooks = all_workbooks, matching_user = matching_user, workbook_list = workbook_list)
